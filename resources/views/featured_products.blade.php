...
<!-- Mirrored from gambolthemes.net/html-items/gambo_supermarket_demo/shop_grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Nov 2020 16:48:55 GMT -->
<head>
		<meta charset="utf-8">
		...
		<link href='{{asset('resources')}}/frontend/vendor/unicons-2.0.1/css/unicons.css' rel='stylesheet'>
		<link href="{{asset('resources')}}/frontend/css/style.css" rel="stylesheet">
		<link href="{{asset('resources')}}/frontend/css/responsive.css" rel="stylesheet">
		<link href="{{asset('resources')}}/frontend/css/night-mode.css" rel="stylesheet">
		
		

		<!-- Vendor Stylesheets -->
		<link href="{{asset('resources')}}/frontend/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
		<link href="{{asset('resources')}}/frontend/vendor/OwlCarousel/assets/owl.carousel.css" rel="stylesheet">
		<link href="{{asset('resources')}}/frontend/vendor/OwlCarousel/assets/owl.theme.default.min.css" rel="stylesheet">
		<link href="{{asset('resources')}}/frontend/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
		<link rel="stylesheet" type="text/css" href="{{asset('resources')}}/frontend/vendor/semantic/semantic.min.css">	
...
<body>
	...
	<!-- Javascripts -->
	<script src="{{asset('resources')}}/frontend/js/jquery-3.3.1.min.js"></script>
	<script src="{{asset('resources')}}/frontend/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
	<script src="{{asset('resources')}}/frontend/vendor/OwlCarousel/owl.carousel.js"></script>
	<script src="{{asset('resources')}}/frontend/vendor/semantic/semantic.min.js"></script>
	<script src="{{asset('resources')}}/frontend/js/jquery.countdown.min.js"></script>
	<script src="{{asset('resources')}}/frontend/js/custom.js"></script>
	<script src="{{asset('resources')}}/frontend/js/offset_overlay.js"></script>
	<script src="{{asset('resources')}}/frontend/js/night-mode.js"></script>
